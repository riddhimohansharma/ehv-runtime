...
class Enclave:
    ...
    def __init__(self, memory_name="ehv_enclave_mem", size=256):
        ...
        try:
            self.shm = shared_memory.SharedMemory(name=self.memory_name, create=True, size=self.size)
    ...
    def attest(self, policy_hash):
        ...
        """
        import time
        # Simulate hardware attestation latency
        time.sleep(0.2)
    ...
    def unseal(self, sealed_data):
        ...
        try:
            ...
            expected_tag = hmac.new(self.secret_key, data_bytes, hashlib.sha256).digest()
